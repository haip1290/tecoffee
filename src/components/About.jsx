import manifestoImg from "../assets/products/dirtymatcha.jpg";
const About = () => {
  return (
    <section className="flex items-center max-h-screen md:h-[80vh] overflow-hidden bg-stone-50">
      <div className="flex-1 flex flex-col justify-center items-center px-10 md:px-20 lg:px-32 text-center space-y-8">
        {/* header */}
        ...
        <h2 className="text-3xl md:text-4xl font-light text-stone-800 leading-tight">
          ...
          <span className="font-serif text-5xl"> big ideas.</span>
        </h2>
