...
const ContactUs = () => {
  return (
    <section
      className="flex flex-col md:flex-row py-16 px-8 h-[70vh]"
      id="contact-cta"
    >
      <div className="flex-1 flex flex-col justify-center items-center gap-4">
        <h2 className="text-6xl tracking-tight font-light">We love to chat!</h2>
        <Link
          to={"contact"}
      ...
      <div className="flex-1">
        <img
          ...
          className="w-full h-full object-cover rounded-3xl md:rounded-2rem shadow-2xl"
        />
      </div>
    </section>
  );
